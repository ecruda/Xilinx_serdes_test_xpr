...
HD_PWD='C:/Users/L/Desktop/Reasearch_Lab/Dr_Ye_pt_2/datao_lily_PAM4/Xilinx_serdes_test_xrp/serdes_test/serdes_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PRBS7_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PRBS7_top.tcl
