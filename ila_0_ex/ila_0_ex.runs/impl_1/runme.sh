...
HD_PWD='c:/Lily_Zhang/SERDES_Xilinx/Xilinx_serdes_test_xpr_repo/ila_0_ex/ila_0_ex.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ila_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source example_ila_0.tcl -notrace
