...
HD_PWD='c:/Lily_Zhang/SERDES_Xilinx/Xilinx_serdes_test_xpr_repo/ila_0_ex/ila_0_ex.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log example_ila_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source example_ila_0.tcl
